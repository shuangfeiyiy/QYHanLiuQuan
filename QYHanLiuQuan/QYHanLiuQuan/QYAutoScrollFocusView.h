...
@protocol QYAutoScrollFocusViewDelegate <NSObject>
/**
 *  点击滚动图触发的事件
 *
 *  @param index 点击的第几个图
...
@interface QYAutoScrollFocusView : UIView

@property (nonatomic, strong) NSArray *focusTitleArr;
@property (nonatomic, strong) UIFont *titleFont;
@property (nonatomic, weak)   id<QYAutoScrollFocusViewDelegate> delegate;
